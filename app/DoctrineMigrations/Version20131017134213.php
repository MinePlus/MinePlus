 ...
 */
class Version20131017134213 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE thread_metadata ADD CONSTRAINT FK_40A577C89D1C3019 FOREIGN KEY (participant_id) REFERENCES users (id)");
        ...
        $this->addSql("ALTER TABLE thread ADD CONSTRAINT FK_31204C833174800F FOREIGN KEY (createdBy_id) REFERENCES users (id)");
        ...
        $this->addSql("ALTER TABLE session CHANGE created created DATETIME NOT NULL");
    }
